...
// Changing message text color
    ...
    private void assignViews() {
        mainSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.personalSwipeRefresh);
        mainCoordinatorLayout = (CoordinatorLayout) findViewById(R.id.personalCoordinator);
    }
